...
const WHATSAPP_NUMBER$2 = "917628954403";
const PHONE_NUMBER = "7628954403";
const ADDRESS = "Opp. of Sanghati Club, near Sankar Chowmuhani, Krishna Nagar, Agartala, Tripura 799001";
const GOOGLE_FORM_URL$6 = "https://docs.google.com/forms/d/e/1FAIpQLSeFu7RpltnY1Nzkf31b9MOe6g6uk51EpSjc6WljVaVeopve2w/viewform";
const contactInfo = [
  {
    icon: Phone,
    label: "Call Us",
  ...
  },
  {
    ...
    link: `https://wa.me/${WHATSAPP_NUMBER$2}?text=Hello%2C%20I%20want%20to%20know%20more%20about%20admissions`,
...
function Contact() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-20 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-7xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-bold text-foreground mb-4", children: "Contact Us" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto", children: "Have questions? Our counsellors are ready to help you take the first step towards your dream college." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-10 items-start", children: [
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-5 h-5", style: { color: info.color } })
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold uppercase tracking-wide text-muted-foreground mb-1", children: info.label }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium text-foreground leading-snug break-words", children: info.value })
                    ] })
                  ]
                },
                info.label
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: {
            background: "linear-gradient(135deg, oklch(0.96 0.02 255), oklch(0.98 0.01 34))"
          },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-foreground mb-2", children: "Ready to get started?" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Take the first step today. Fill out our quick form or reach out directly — we'll get back to you within a few hours." })
            ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "a",
                    {
                      href: GOOGLE_FORM_URL$6,
                      target: "_blank",
                      rel: "noopener noreferrer",
                      children: "Apply Now — Fill Registration Form"
                    }
                  )
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "a",
                    {
                      href: `https://wa.me/${WHATSAPP_NUMBER$2}?text=Hello%2C%20I%20want%20to%20know%20more%20about%20admissions`,
                      target: "_blank",
                      rel: "noopener noreferrer",
                      children: [
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "a",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-foreground", children: "View on Google Maps" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Krishna Nagar, Agartala, Tripura" })
                    ]
                  }
                )
              }
...
const GOOGLE_FORM_URL$5 = "https://docs.google.com/forms/d/e/1FAIpQLSeFu7RpltnY1Nzkf31b9MOe6g6uk51EpSjc6WljVaVeopve2w/viewform";
const courses$1 = [
  {
    icon: Stethoscope,
    title: "Medical",
    description: "MBBS, BDS, BAMS & more in top medical colleges across India with expert guidance.",
    badge: "High Demand",
  ...
  },
  {
    icon: Cpu,
    title: "Engineering",
    description: "B.Tech in CSE, ECE, Civil & Mechanical at reputed engineering institutions.",
    badge: "Popular",
  ...
  },
  {
    icon: Pill,
    title: "Pharmacy",
    description: "B.Pharm & D.Pharm programs in renowned pharmacy colleges with strong placements.",
    badge: "Growing Field",
  ...
  },
  {
    icon: Heart,
    title: "Nursing",
    description: "B.Sc & GNM Nursing programs in professional nursing colleges and hospitals.",
  ...
  },
  {
    icon: Briefcase,
    title: "Management",
    description: "BBA, MBA & PGDM programs in top business schools for future leaders.",
...
function Courses() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "courses", className: "py-20 bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-7xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-bold text-foreground mb-4", children: "Courses We Specialise In" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto", children: "From medical to management — we help you secure a seat in the field that matches your passion and potential." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          courses$1.map((course) => {
            const Icon2 = course.icon;
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: GOOGLE_FORM_URL$5,
                target: "_blank",
                rel: "noopener noreferrer",
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-foreground mb-2 group-hover:text-primary transition-smooth", children: course.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed mb-4", children: course.description }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              style: {
                background: "linear-gradient(135deg, oklch(0.35 0.16 255), oklch(0.25 0.14 260))"
              },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mb-3", style: { color: "#E0E0E0" }, children: "Not sure which course is right for you?" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-bold text-lg mb-4", children: "Get Free Career Counselling" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "a",
                  {
                    href: GOOGLE_FORM_URL$5,
...
const GOOGLE_FORM_URL$4 = "https://docs.google.com/forms/d/e/1FAIpQLSeFu7RpltnY1Nzkf31b9MOe6g6uk51EpSjc6WljVaVeopve2w/viewform";
const WHATSAPP_NUMBER$1 = "917628954403";
const navLinks$1 = [
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "footer",
    {
      ...
      style: {
        background: "linear-gradient(180deg, oklch(0.22 0.13 262) 0%, oklch(0.16 0.1 264) 100%)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-7xl mx-auto px-4 relative z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Admission Host is a trusted education consultancy helping students get admission in top colleges across India. With 9+ years of experience and 500+ successful placements, we guide students to their dream careers."
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    href: `https://wa.me/${WHATSAPP_NUMBER$1}`,
                    target: "_blank",
                    rel: "noopener noreferrer",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-bold text-white uppercase tracking-widest mb-5", children: "Quick Links" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3", children: [
                navLinks$1.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    href: link.href,
                    onClick: (e) => {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-bold text-white uppercase tracking-widest mb-5", children: "Our Courses" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: courses.map((course) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 flex-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      ...
                      children: "Opp. of Sanghati Club, near Sankar Chowmuhani, Krishna Nagar, Agartala, Tripura 799001"
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", style: { color: "rgba(255,255,255,0.48)" }, children: [
                  "© ",
                  year,
                  " Admission Host. All rights reserved."
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", style: { color: "rgba(255,255,255,0.48)" }, children: [
...
const GOOGLE_FORM_URL$3 = "https://docs.google.com/forms/d/e/1FAIpQLSeFu7RpltnY1Nzkf31b9MOe6g6uk51EpSjc6WljVaVeopve2w/viewform";
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-card shadow-elevated py-2" : "bg-card/95 backdrop-blur-sm shadow-subtle py-3"}`,
      "data-ocid": "header-nav",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-7xl mx-auto px-4 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: GOOGLE_FORM_URL$3, target: "_blank", rel: "noopener noreferrer", children: "Book Consultation" })
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
        ...
        mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-card border-t border-border shadow-elevated animate-slide-down", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "container max-w-7xl mx-auto px-4 py-4 flex flex-col gap-1", children: [
...
const GOOGLE_FORM_URL$2 = "https://docs.google.com/forms/d/e/1FAIpQLSeFu7RpltnY1Nzkf31b9MOe6g6uk51EpSjc6WljVaVeopve2w/viewform";
const highlights = [
...
function Hero() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: {
        background: "linear-gradient(135deg, oklch(0.35 0.16 255) 0%, oklch(0.22 0.14 260) 60%, oklch(0.18 0.12 265) 100%)"
      },
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container max-w-7xl mx-auto px-4 py-16 md:py-24 relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
              ...
              "h1",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative inline-block", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.72 0.22 34)" }, children: "Top Colleges" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                style: { color: "#E8E8E8" },
                children: "We guide you to the right career path with expert counselling — from choosing the right course to securing your seat in top institutions across India."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5 mb-10", children: highlights.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "li",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-4", "data-ocid": "hero-cta-group", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  asChild: true,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative flex justify-center lg:justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      style: {
                        background: "linear-gradient(to top, oklch(0.22 0.14 260), transparent)"
                      }
                    }
                  )
                ]
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-4 -left-4 bg-card rounded-2xl px-4 py-3 shadow-elevated animate-float", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full gradient-primary flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground text-xs font-bold", children: "9+" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-foreground", children: "Years Experience" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Trusted consultancy" })
              ] })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-4 -right-4 bg-card rounded-2xl px-4 py-3 shadow-elevated", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-foreground", children: "500+ Students" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Successfully placed" })
              ] })
            ] }) })
          ] }) })
        ] }) }),
...
const GOOGLE_FORM_URL$1 = "https://docs.google.com/forms/d/e/1FAIpQLSeFu7RpltnY1Nzkf31b9MOe6g6uk51EpSjc6WljVaVeopve2w/viewform";
const steps = [
  {
    step: "01",
...
function Registration() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "register", className: "py-20 bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container max-w-7xl mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-10 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl md:text-4xl font-bold text-foreground mb-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.35 0.16 255)" }, children: "4 Simple Steps" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-8 max-w-md", children: "Our streamlined process ensures you secure your dream college admission without stress or confusion." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", "data-ocid": "admission-steps", children: steps.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-foreground text-sm", children: s.label }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style: {
          background: "linear-gradient(135deg, oklch(0.35 0.16 255), oklch(0.22 0.14 260))"
        },
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: "⚡ Limited Seats for 2025 Batch"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h3",
              {
                ...
                children: "Register Now & Secure Your Future"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                style: { color: "#E0E0E0" },
                children: "Join 500+ students who have already secured their dream college admission with Admission Host."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 mb-8 text-left max-w-xs mx-auto", children: [
              "Free initial consultation",
              "No hidden charges",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "No spam. We respect your privacy."
              }
            )
          ] })
        ]
...
const GOOGLE_FORM_URL = "https://docs.google.com/forms/d/e/1FAIpQLSeFu7RpltnY1Nzkf31b9MOe6g6uk51EpSjc6WljVaVeopve2w/viewform";
const services = [
  {
    icon: BookOpen,
    title: "Admission Guidance",
    description: "Step-by-step support through the entire admission process — from form filling to final enrollment in your dream college.",
    features: ["Document preparation", "Form assistance", "Deadline tracking"]
  },
  {
    icon: Compass,
    title: "Career Counselling",
    description: "One-on-one career counselling sessions to identify your strengths and align them with the right course and career path.",
    features: ["Aptitude assessment", "Career mapping", "Industry insights"]
  },
  {
    icon: Award,
    title: "Scholarship Assistance",
    description: "Helping students discover and apply for merit-based, need-based, and government scholarships to reduce financial burden.",
    features: [
      "Scholarship search",
      "Application support",
      "Eligibility check"
  ...
  },
  {
    ...
    description: "Expert comparison of colleges based on ranking, fees, placement records, and your academic profile to find the best fit.",
    features: [
      "College comparison",
      "Campus insights",
...
function Services() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "services", className: "py-20 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-7xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-bold text-foreground mb-4", children: "Our Services" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto", children: "Comprehensive support at every step of your admission journey — we handle the complexity so you can focus on your future." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      background: isOdd ? "oklch(0.35 0.16 255 / 0.08)" : "oklch(0.59 0.24 34 / 0.08)"
                    },
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Icon2,
                      {
                        className: "w-7 h-7",
                        style: {
                          color: isOdd ? "oklch(0.35 0.16 255)" : "oklch(0.59 0.24 34)"
                        }
                      }
                    )
                  }
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-foreground mb-2", children: service.title }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: service.features.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "li",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            ...
                            style: {
                              background: isOdd ? "oklch(0.35 0.16 255)" : "oklch(0.59 0.24 34)"
                            }
                          }
                        ),
                        f
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: GOOGLE_FORM_URL, target: "_blank", rel: "noopener noreferrer", children: "Get Started Today" })
      }
    ) })
  ] }) });
}
const testimonials = [
  {
    ...
    review: "Admission Host made my dream of becoming a doctor a reality. Their guidance through the entire process was invaluable. Got admission in a top medical college within just 2 weeks!",
    initials: "PS",
    rating: 5,
    color: "oklch(0.35 0.16 255)",
  ...
  },
  {
    ...
    review: "Very helpful consultancy. The team was professional, transparent about all charges, and helped me get into my preferred engineering branch. Highly recommend to all students!",
    initials: "RD",
    rating: 5,
    color: "oklch(0.59 0.24 34)",
  ...
  },
  {
    ...
    review: "I was confused about which college to choose for nursing. Admission Host counselled me perfectly and helped me secure a seat in a reputed college. Exceptional service!",
    initials: "SR",
    rating: 5,
    color: "oklch(0.35 0.16 255)",
    bg: "oklch(0.35 0.16 255 / 0.1)"
  },
  {
    ...
    review: "The scholarship assistance was a game changer for me. They found a scholarship I didn't even know about and helped me save a significant amount on my MBA fees.",
    initials: "AC",
    rating: 5,
    color: "oklch(0.59 0.24 34)",
    bg: "oklch(0.59 0.24 34 / 0.1)"
  },
  {
    ...
    review: "Excellent career counselling! They took time to understand my situation and recommended the best pharmacy college within my budget. Process was completely transparent.",
    initials: "MP",
    rating: 5,
    color: "oklch(0.35 0.16 255)",
    bg: "oklch(0.35 0.16 255 / 0.1)"
  },
  {
    ...
    review: "From document preparation to final admission, Admission Host was with me at every step. Their network of colleges is impressive. Got admission faster than I expected!",
    initials: "SD",
    rating: 5,
    color: "oklch(0.59 0.24 34)",
    bg: "oklch(0.59 0.24 34 / 0.1)"
...
function StarRating({ count, name }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-0.5", children: stars.map((key) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    Star,
    {
...
function Testimonials() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "testimonials", className: "py-20 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-7xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-bold text-foreground mb-4", children: "What Our Students Say" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto", children: "Don't just take our word for it — hear from the students we've helped achieve their academic dreams." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 pt-4 border-t border-border", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground truncate", children: t.course })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-auto shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(StarRating, { count: t.rating, name: t.name }) })
              ] })
            ]
          },
          t.name
...
function TrustStats() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "trust", className: "py-16 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container max-w-7xl mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-6 h-6", style: { color: stat.color } })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground leading-snug", children: stat.description })
            ]
          },
          stat.label
        );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "a",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold whitespace-nowrap", children: "WhatsApp" })
      ]
    }
  );
}
const reasons = [
  {
    ...
    description: "Our team of experienced counsellors have placed 500+ students in top colleges. We know what works and guide you accordingly.",
    stat: "500+ placements"
  },
  {
    icon: UserCheck,
    title: "Personalized Support",
    description: "Every student is unique. We provide one-on-one counselling tailored to your academic background, interests, and career goals.",
    stat: "1-on-1 sessions"
  },
  {
    icon: IndianRupee,
    title: "Affordable Colleges",
    description: "We help you find quality education at colleges that fit your budget — without compromising on academic standards or placements.",
    stat: "Budget-friendly options"
  },
  {
    icon: Eye,
    title: "Transparent Process",
    description: "No hidden fees, no false promises. We maintain complete transparency at every step so you and your family stay informed.",
...
function WhyChooseUs() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: {
        background: "linear-gradient(135deg, oklch(0.35 0.16 255) 0%, oklch(0.28 0.15 258) 50%, oklch(0.22 0.13 262) 100%)"
      },
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-7xl mx-auto px-4 relative z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-200 max-w-xl mx-auto leading-relaxed", children: "We've spent over 9 years perfecting the art of helping students find their ideal colleges with confidence and clarity." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background font-body", children: [
